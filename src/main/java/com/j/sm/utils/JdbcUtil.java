 ...
 * @Author orange
 * @Date 2020-11-14 21:50
 **/

public class JdbcUtil {
    private static final String URL = "jdbc:mysql://localhost:3306/student_manage?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=GMT%2B8";
